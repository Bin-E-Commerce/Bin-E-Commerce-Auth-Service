...
export class NavigationItem {
  ...
  @Column({ name: "group_code", type: "varchar", length: 80, default: "default" })
  groupCode: string;

  @Column({ name: "group_label", type: "varchar", length: 120, default: "Chung" })
  groupLabel: string;
  ...
  @Column({ name: "required_scope", type: "varchar", length: 40, nullable: true })
