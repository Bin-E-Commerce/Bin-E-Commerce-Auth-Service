...
export class UserAddress {
  ...
  @Column({ name: "ghn_province_name", type: "varchar", length: 100, nullable: true })
  ...
  @Column({ name: "ghn_district_name", type: "varchar", length: 100, nullable: true })
  ...
  @Column({ name: "ghn_ward_name", type: "varchar", length: 100, nullable: true })
