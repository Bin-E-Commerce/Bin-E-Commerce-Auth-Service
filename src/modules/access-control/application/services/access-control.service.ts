...
import type { UpdateRolePermissionDto } from '@/modules/access-control/presentation/dto/update-role-permission.dto';
import type {
    AccessAreaDto,
...
export class AccessControlService {
    ...
    async getAdminOverview() {
        const [roles, permissions, rolePermissions, navigation] =
            await Promise.all([
